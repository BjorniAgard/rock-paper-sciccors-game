...
function win(userChoice, compChoice){
	...
	result_p.innerHTML = `<span style="color:#F9F345;">${makeWord(userChoice)}</span> beats <span style="color:#FE0655;">${makeWord(compChoice)}</span>. You win!`;
}
...
function lose(userChoice, compChoice){
	...
	showCompChoice(compChoice);
	result_p.innerHTML = `<span style="color:#F9F345;">${makeWord(userChoice)}</span> gets beaten by <span style="color:#FE0655;">${makeWord(compChoice)}</span>. You lose!`;
}

function draw(userChoice, compChoice){
	showCompChoice(compChoice);
	result_p.innerHTML = `<span style="color:#F9F345;">${makeWord(userChoice)}</span> is the same as <span style="color:#FE0655;">${makeWord(compChoice)}</span>. It's a draw!`;
}
